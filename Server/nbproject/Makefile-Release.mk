...
${OBJECTDIR}/Commands/CommandAddSubscriptions.o: Commands/CommandAddSubscriptions.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandAddSubscriptions.o Commands/CommandAddSubscriptions.cpp

${OBJECTDIR}/Commands/CommandClientSubscription.o: Commands/CommandClientSubscription.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandClientSubscription.o Commands/CommandClientSubscription.cpp

${OBJECTDIR}/Commands/CommandEnterGrid.o: Commands/CommandEnterGrid.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandEnterGrid.o Commands/CommandEnterGrid.cpp

${OBJECTDIR}/Commands/CommandExitGrid.o: Commands/CommandExitGrid.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandExitGrid.o Commands/CommandExitGrid.cpp

${OBJECTDIR}/Commands/CommandHit.o: Commands/CommandHit.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandHit.o Commands/CommandHit.cpp

${OBJECTDIR}/Commands/CommandInitShot.o: Commands/CommandInitShot.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandInitShot.o Commands/CommandInitShot.cpp

${OBJECTDIR}/Commands/CommandMetaHit.o: Commands/CommandMetaHit.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandMetaHit.o Commands/CommandMetaHit.cpp

${OBJECTDIR}/Commands/CommandProcesMetas.o: Commands/CommandProcesMetas.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandProcesMetas.o Commands/CommandProcesMetas.cpp

${OBJECTDIR}/Commands/CommandProcessor.o: Commands/CommandProcessor.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandProcessor.o Commands/CommandProcessor.cpp

${OBJECTDIR}/Commands/CommandQueryCmp.o: Commands/CommandQueryCmp.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandQueryCmp.o Commands/CommandQueryCmp.cpp

${OBJECTDIR}/Commands/CommandRemove.o: Commands/CommandRemove.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandRemove.o Commands/CommandRemove.cpp

${OBJECTDIR}/Commands/CommandSignalFighter.o: Commands/CommandSignalFighter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandSignalFighter.o Commands/CommandSignalFighter.cpp

${OBJECTDIR}/Commands/CommandTargetPosUpdate.o: Commands/CommandTargetPosUpdate.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandTargetPosUpdate.o Commands/CommandTargetPosUpdate.cpp

${OBJECTDIR}/Commands/CommandTimedSubscribeUpdate.o: Commands/CommandTimedSubscribeUpdate.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandTimedSubscribeUpdate.o Commands/CommandTimedSubscribeUpdate.cpp
...
${OBJECTDIR}/Commands/CommandUpdateMetas.o: Commands/CommandUpdateMetas.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/CommandUpdateMetas.o Commands/CommandUpdateMetas.cpp

${OBJECTDIR}/Commands/Processable.o: Commands/Processable.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/Processable.o Commands/Processable.cpp
...
${OBJECTDIR}/Commands/inputCommands/CommandIChangeOrders.o: Commands/inputCommands/CommandIChangeOrders.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/inputCommands/CommandIChangeOrders.o Commands/inputCommands/CommandIChangeOrders.cpp

${OBJECTDIR}/Commands/inputCommands/CommandIChangeSubTG.o: Commands/inputCommands/CommandIChangeSubTG.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands/inputCommands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/inputCommands/CommandIChangeSubTG.o Commands/inputCommands/CommandIChangeSubTG.cpp

${OBJECTDIR}/Commands/inputCommands/CommandIFit.o: Commands/inputCommands/CommandIFit.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands/inputCommands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/inputCommands/CommandIFit.o Commands/inputCommands/CommandIFit.cpp

${OBJECTDIR}/Commands/inputCommands/CommandISubStatusField.o: Commands/inputCommands/CommandISubStatusField.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands/inputCommands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/inputCommands/CommandISubStatusField.o Commands/inputCommands/CommandISubStatusField.cpp

${OBJECTDIR}/Commands/inputCommands/CommandIUnfit.o: Commands/inputCommands/CommandIUnfit.cpp 
	${MKDIR} -p ${OBJECTDIR}/Commands/inputCommands
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands/inputCommands/CommandIUnfit.o Commands/inputCommands/CommandIUnfit.cpp
...
${OBJECTDIR}/Sspacebjects/Ordres/CommandOrderThread.o: Sspacebjects/Ordres/CommandOrderThread.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/CommandOrderThread.o Sspacebjects/Ordres/CommandOrderThread.cpp
...
${OBJECTDIR}/Sspacebjects/Ordres/Compiler/CommandCompiler.o: Sspacebjects/Ordres/Compiler/CommandCompiler.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Compiler/CommandCompiler.o Sspacebjects/Ordres/Compiler/CommandCompiler.cpp

${OBJECTDIR}/Sspacebjects/Ordres/Compiler/CompilerEmitAssist.o: Sspacebjects/Ordres/Compiler/CompilerEmitAssist.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/Ordres/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Compiler/CompilerEmitAssist.o Sspacebjects/Ordres/Compiler/CompilerEmitAssist.cpp

${OBJECTDIR}/Sspacebjects/Ordres/Compiler/SOrderCompilerVisitor.o: Sspacebjects/Ordres/Compiler/SOrderCompilerVisitor.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/Ordres/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Compiler/SOrderCompilerVisitor.o Sspacebjects/Ordres/Compiler/SOrderCompilerVisitor.cpp

${OBJECTDIR}/Sspacebjects/Ordres/Compiler/SOrderProgramPrinter.o: Sspacebjects/Ordres/Compiler/SOrderProgramPrinter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/Ordres/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Compiler/SOrderProgramPrinter.o Sspacebjects/Ordres/Compiler/SOrderProgramPrinter.cpp

${OBJECTDIR}/Sspacebjects/Ordres/Compiler/TypeChecker.o: Sspacebjects/Ordres/Compiler/TypeChecker.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/Ordres/Compiler
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Compiler/TypeChecker.o Sspacebjects/Ordres/Compiler/TypeChecker.cpp
...
${OBJECTDIR}/Sspacebjects/Ordres/Generated/Lexer.o: Sspacebjects/Ordres/Generated/Lexer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Generated/Lexer.o Sspacebjects/Ordres/Generated/Lexer.cpp

${OBJECTDIR}/Sspacebjects/Ordres/Generated/Parser.o: Sspacebjects/Ordres/Generated/Parser.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/Ordres/Generated
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Generated/Parser.o Sspacebjects/Ordres/Generated/Parser.cpp
...
${OBJECTDIR}/Sspacebjects/Ordres/SOrdreProgram.o: Sspacebjects/Ordres/SOrdreProgram.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/Ordres
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/SOrdreProgram.o Sspacebjects/Ordres/SOrdreProgram.cpp
...
${OBJECTDIR}/Sspacebjects/Ordres/Terminals/SOrderIntegerLiteral.o: Sspacebjects/Ordres/Terminals/SOrderIntegerLiteral.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Terminals/SOrderIntegerLiteral.o Sspacebjects/Ordres/Terminals/SOrderIntegerLiteral.cpp
...
${OBJECTDIR}/Sspacebjects/Ordres/Utils/SOrderDotBuilder.o: Sspacebjects/Ordres/Utils/SOrderDotBuilder.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Utils/SOrderDotBuilder.o Sspacebjects/Ordres/Utils/SOrderDotBuilder.cpp

${OBJECTDIR}/Sspacebjects/Ordres/Utils/SOrderSourcePosition.o: Sspacebjects/Ordres/Utils/SOrderSourcePosition.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/Ordres/Utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Utils/SOrderSourcePosition.o Sspacebjects/Ordres/Utils/SOrderSourcePosition.cpp

${OBJECTDIR}/Sspacebjects/Ordres/Utils/SOrderVisitor.o: Sspacebjects/Ordres/Utils/SOrderVisitor.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/Ordres/Utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/Ordres/Utils/SOrderVisitor.o Sspacebjects/Ordres/Utils/SOrderVisitor.cpp
...
${OBJECTDIR}/Sspacebjects/SFighter.o: Sspacebjects/SFighter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/SFighter.o Sspacebjects/SFighter.cpp

${OBJECTDIR}/Sspacebjects/SFighterType.o: Sspacebjects/SFighterType.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/SFighterType.o Sspacebjects/SFighterType.cpp
...
${OBJECTDIR}/Sspacebjects/SMetaShot.o: Sspacebjects/SMetaShot.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/SMetaShot.o Sspacebjects/SMetaShot.cpp
...
${OBJECTDIR}/Sspacebjects/SUnit.o: Sspacebjects/SUnit.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/SUnit.o Sspacebjects/SUnit.cpp

${OBJECTDIR}/Sspacebjects/SUnitType.o: Sspacebjects/SUnitType.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/SUnitType.o Sspacebjects/SUnitType.cpp
...
${OBJECTDIR}/Sspacebjects/subsystems/SSubTypeFighter.o: Sspacebjects/subsystems/SSubTypeFighter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sspacebjects/subsystems
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sspacebjects/subsystems/SSubTypeFighter.o Sspacebjects/subsystems/SSubTypeFighter.cpp
